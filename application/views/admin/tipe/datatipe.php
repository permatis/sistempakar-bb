...
<head>
	...
	<title>Data Tipe Blackberry</title>
...
<body>
	<div class="container">
		...
		<div class="container">
			<h3>DATA TIPE BLACKBERRY<?php echo anchor('datatipe/tambah', 'Tambah Data', array('class' => 'btn btn-success pojok'));?></h3>
			<hr />
			<table class="table table-striped table-bordered table-hover" id="example">
				...
				?>
					<tr>
						...
						<td width="100px"><?php echo anchor('datatipe/edit/'.$row->id_tipe, '<button type="button" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span></button>',array('title' => 'Edit'));?>
						<?php echo anchor('datatipe/hapus/'.$row->id_tipe, '<button type="button" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span></button>',array('title' => 'Hapus'));?></td>
					</tr>
				<?php 
				endforeach;
				?>
