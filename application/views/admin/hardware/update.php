...
<body>
	<div class="container">
		...
		<div class="well">
			...
			<?php echo form_open('hardware/simpan/'.$row->id_masalah, array('class' => 'form-horizontal')); ?>
				<fieldset>
					<legend><?php echo $title; ?></legend>
					<?php echo form_hidden('kd_tipe', $row->kd_tipe);?>
					<?php echo form_hidden('kd_masalah', $row->kd_masalah);?>
					<div class="form-group">
						<?php echo form_label('Masalah', 'masalah', array('class' => 'col-lg-3 form-label')); ?>
						<div class="col-lg-8">
							<?php echo form_textarea(array('name' => 'masalah', 'class tinymce' => 'form-control', 'value' => $row->masalah)); ?>
						</div>
					</div>
					<div class="form-group">
						<?php echo form_label('Solusi', 'solusi', array('class' => 'col-lg-3 form-label')); ?>
						<div class="col-lg-8">
							<?php echo form_textarea(array('name' => 'solusi', 'class' => 'form-control tinymce', 'value' => $row->solusi)); ?>
						</div>
					</div>
					<div class="form-group">
