...
<body>
	<div class="container">
		...
		<div class="well">
			...
			<?php echo form_open('software/simpan/'.$row->id_masalah, array('class' => 'form-horizontal')); ?>
				<fieldset>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<?php echo form_textarea(array('name' => 'masalah', 'class' => 'form-control', 'value' => $row->masalah)); ?>
						</div>
					</div>
					<div class="form-group">
