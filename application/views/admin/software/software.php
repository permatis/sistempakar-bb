...
<head>
	...
	<title>Data Masalah dan Solusi Software</title>
...
<body>
	<div class="container">
		...
		<div class="container">
			<h3>DATA MASALAH DAN SOLUSI SOFTWARE <?php echo anchor('software/tambah', 'Tambah Data', array('class' => 'btn btn-success pojok'));?></h3>
			<hr />
			<table class="table table-striped table-bordered table-hover" id="example">
				...
				?>
					<tr>
						...
						<td width="100px"><?php echo anchor('software/edit/'.$hard->id_masalah, '<button type="button" class="btn btn-default"><span class="glyphicon glyphicon-edit"></span></button>',array('title' => 'Edit'));?>
						<?php echo anchor('software/hapus/'.$hard->id_masalah, '<button type="button" class="btn btn-default"><span class="glyphicon glyphicon-trash"></span></button>',array('title' => 'Hapus'));?></td>
					</tr>
				<?php 
				endforeach;
				?>
