	...
	<div class="container">
			...
			<div class="container">
				<div class="collapse navbar-collapse bs-navbar-collapse" id="collapse">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="<?php echo index_page(); ?>">Register</a></li>
		...
		<div class="col-lg-8 well">
			<?php echo form_open('register', array('class' => 'form-horizontal')); ?>
				<fieldset>
					<legend>REGISTER APLIKASI</legend>
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<?php echo form_input(array('name' => 'nama', 'class' => 'form-control', 'value' => $this->input->post('nama'))); ?>
						</div>
					</div>
					<div class="form-group">
						<?php echo form_label('Email','email', array('class' => 'col-lg-3 form-label')); ?>
						<div class="col-lg-8">
					...
					<div class="form-group">
						...
						<div class="col-lg-8">
							<?php echo form_password(array('name' => 'password', 'class' => 'form-control', 'value' => $this->input->post('password'))); ?>
						</div>
					</div>
					<div class="form-group">
						<?php echo form_label('Ulangi Password', 'pwd_ulang', array('class' => 'col-lg-3 form-label')); ?>
						<div class="col-lg-8">
							<?php echo form_password(array('name' => 'pwd_ulang', 'class' => 'form-control', 'value' => $this->input->post('pwd_ulang'))); ?>
						</div>
					</div>
					<div class="form-group">
						<div class="col-lg-8 col-lg-offset-3">
							<?php echo form_submit(array('value' => 'Register', 'class' => 'btn btn-success')) ?>
						</div>
					</div>
				</fieldset>	
			<?php echo form_close(); ?>
